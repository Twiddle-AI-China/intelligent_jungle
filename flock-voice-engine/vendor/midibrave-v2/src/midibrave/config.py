...
class TrainConfig:
    ...
    # Experimental Phase-1 balancing path.  When positive, the ordinary
    # reconstruction update is followed by an independent CLAP-only AdamW
    # substep that updates Decoder parameters only.  Keeping this at zero
    # preserves the production training path bit-for-bit.
    clap_decoder_step_lr: float = 0.0
